...
import stateList from '../../statelist/state.json';
...
function Register() {
  ...
  validationErrorMessage = (event) => {
    ...
    switch (name) {
      case 'Name': 
        errors.user.Name = value.length < 1 ? 'Enter First Name' : '';
        break;
      case 'email': 
  ...
  render() {
    const { Name, age, email, telephone } = this.state.user;
      ...
      <div className="rightPanel">
        <div className="row">
          ...
          <div className="col-sm-3 mb-2">
            <input type="text" value={Name} name="Name" onChange={(e) => { this.inputChange(e)} } className="form-control" placeholder="First Name" />
        ...
        <div className="row">
          ...
          <div className="col-sm-6 mb-2">
            <input type="text" value={age} onChangeInputRange={this.onChangeInputRange} />
          </div>
          <div className="col-sm-4">
          </div>
        </div>
        ...
        <div className="row">
          ...
          <div className="col-sm-6 mb-2">
            <input type="text" pattern="[0-9]" maxLength="10" value={telephone} name="telephone" onChange={(e) => { this.inputChange(e)} }  className="form-control" id="telephone" placeholder="(212)477-1000" />
